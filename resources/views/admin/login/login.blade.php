            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    {!!Form::open(['url'=>'/login','method'=>'POST'])!!}
                      ...
                      {!!Form::email('email',$value=null,['class'=>'form-controller','placeholder'=>'enter your email'])!!}
                    @if ($errors->has('email'))
                      ...
                      {!!Form::password('password',['class'=>'form-controller','placeholder'=>'enter your password'])!!}
